...
const api: RendererApi = {
  ...
  cloudShopOperation: operation => ipcRenderer.invoke('cloud:shop-operation', operation),
  uploadShopImageAsset: (dataUrl, crop) => ipcRenderer.invoke('cloud:upload-image-asset', dataUrl, crop),
